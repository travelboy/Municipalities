<%@ Page Title="" Language="C#" MasterPageFile="~/Municipalities.Master" AutoEventWireup="true" CodeBehind="YTActivities.aspx.cs" Inherits="Municipalities.YTActivities" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="container">
		  	<div class="row">
		  	    <img src="images/ytbanner.png" style="width: 780px; padding-left: 30px;"  />
				...
				<section class="grid-wrap">
					<ul class="grid">
					     <asp:Repeater ID="rptYT" runat="server"><ItemTemplate>
						<li class="grid-sizer"></li><!-- for Masonry column width -->
						<li>
							<figure>
									<a href='https://www.youtube.com/watch?v=<%#Eval("YTVideo")%>'><img src="images/youtubeplay.png" alt="images/youtubeplay.png"  /></a>
								<figcaption>
								    
                                    <h3  style="color:#d36366 !important"><%#Eval("YTTitle") %></h3>
                                     <h6>Видеото е креирано на  <%#Eval("YTDay") %>/<%#Eval("YTMonth") %>/<%#Eval("YTYear") %></h6> 
         ...
         <asp:Repeater ID="rptYT1" runat="server"><ItemTemplate>
					<ul>
						<li>
	...
	<a href='Activities.aspx' ><img src='images/FacebookBanner.png' class="img-responsive" alt="" height="300px" width="560px"/></a>
                     ...
                     <a href='TwitterActivities.aspx' ><img src='images/twitterbanner.jpg' class="img-responsive" alt="" height="250px" width="550px"/></a>
		  	</div>
		  </div>
